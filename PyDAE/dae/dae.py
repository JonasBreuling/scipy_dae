...
# TODO: Is it necessary to implement a common base class besides the one of scipy?
# from .base import DaeSolver
from scipy.integrate._ivp.base import OdeSolver as DaeSolver
...
def solve_dae(fun, t_span, y0, method='BDF', t_eval=None, dense_output=False,
            #   mass_matrix=None, events=None, vectorized=False, args=None, 
              events=None, vectorized=False, args=None, 
              **options):
    """Solve an initial value problem for a system of ODEs.

    This function numerically integrates a system of ordinary differential
    equations or differential algebraic equations given an initial value::
    ...
    method : string or `DaeSolver`, optional
        Integration method to use:
            ...
            * 'BDF' (default): Implicit multi-step variable-order (1 to 5) method 
    ...
    **options
    ...
    if dense_output:
        if t_eval is None:
            ...
            sol = OdeSolution(
                ti, interpolants, alt_segment=True if method is BDF else False
            )
    else:
        sol = None
