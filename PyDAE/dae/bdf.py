...
from scipy.integrate._ivp.common import (
    ...
    norm, EPS, num_jac, validate_first_step, warn_extraneous,
)
...
class BDF(OdeSolver):
    ...
    def __init__(self, fun, t0, y0, t_bound, max_step=np.inf,
        ...
        D[0] = self.y
        # TODO: Should we muliply this with M?
        # D[1] = f * self.h_abs * self.direction
        D[1] = self.mass_matrix @ f * self.h_abs * self.direction
        self.D = D
